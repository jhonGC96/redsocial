...
beforetecla INT check (beforetecla >0 and beforetecla <=10), aftertecla INT check (aftertecla >0 and aftertecla <=10), puntaje_tecn int,  
...
beforeconocimiento INT check (beforeconocimiento >0 and beforeconocimiento <=10), afterconocimiento INT check (afterconocimiento >0 and afterconocimiento <=10), puntaje_conocimiento int,  
...
beforedesempeno INT check (beforedesempeno >0 and beforedesempeno <=10), afterdesempeno INT check (afterdesempeno >0 and afterdesempeno <=10), puntaje_desempeno int,  
...
beforehabilidad INT check (beforehabilidad >0 and beforehabilidad <=10), afterhabilidad INT check (afterhabilidad >0 and afterhabilidad <=10), puntaje_conocimiento int,  
